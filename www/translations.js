...
const TRANSLATION_EN = {
    ...
    delete: "Delete",
    about: "About",
    aboutText: "Pulkka is a clock-in, clock-out application that allows you to create and manage time records for coming to work and leaving work.\n\nNote that Pulkka does not save your data to any server, but all data is saved to the browser's memory (localStorage) so if you clear the browser's page history, you will lose all records. However, depending on the device as a installed PWA, the data may be saved more persistently.",
...
const TRANSLATION_FI = {
    ...
    aboutText: "Pulkka on työleimaussovellus jolla voit luoda ja hallita töihintulomerkintöjä ja lähtömerkintöjä. Voit myös tyhjentää kaikki merkinnät.\n\nHuomioi, että Pulkka ei tallenna tietojasi mihinkään palvelimelle, vaan kaikki tiedot tallennetaan selaimen muistiin (localStorage) joten jos tyhjennät selaimen sivuhistorian niin menetät kaikki merkinnät. Jos kuitenkin asennat Pulkka PWA-sovelluksena laitteeseen, niin tiedot saattavat tallentua pysyvämmin.",
